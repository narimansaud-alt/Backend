...
import { OrganizationCreate } from "@/components/management/organization-create";

export function DataError({ message, requestId, status, code }: { message: string; requestId?: string; status?: number; code?: string }) {
  if (code === "ORGANIZATION_REQUIRED") return <OrganizationCreate />;
